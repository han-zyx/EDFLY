...
//         // Kafka Consumer Properties
//         Properties consumerProps = new Properties();
//         consumerProps.setProperty("bootstrap.servers", "kafka:9092"); // Updated from localhost:9092
//         consumerProps.setProperty("group.id", "flink-consumer-group");
...
//         // Kafka Producer Properties (optional: for clarity and consistency)
//         Properties producerProps = new Properties();
//         producerProps.setProperty("bootstrap.servers", "kafka:9092"); // Updated from localhost:9092
...
//             })
//             .addSink(new FlinkKafkaProducer<>(
//                 "output-topic", new SimpleStringSchema(), producerProps)); // Updated to use producerProps
...
//         // Kafka Consumer Properties
//         Properties consumerProps = new Properties();
//         consumerProps.setProperty("bootstrap.servers", "localhost:9092"); // Updated from localhost:9092
//         consumerProps.setProperty("group.id", "flink-consumer-group");
...
//         // Kafka Producer Properties (optional: for clarity and consistency)
//         Properties producerProps = new Properties();
//         producerProps.setProperty("bootstrap.servers", "localhost:9092"); // Updated from localhost:9092
